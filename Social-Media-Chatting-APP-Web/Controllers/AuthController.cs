...
namespace Social_Media_Chatting_APP_Web.Controllers
{
    /// <summary>
    ...
    public class AuthController(IAuthService authService) : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterDto dto)
        {
            ...
            // Result.IsSuccess drives the HTTP status.
            // On failure, result.Errors contains structured error details.
            if (!result.IsSuccess)
        ...
        public async Task<IActionResult> GoogleLogin([FromBody] GoogleLoginDto dto)
        {
            ...
            // This is done in the controller — not the service — because it is
            ...
            {
                // Invalid, expired, or tampered Google token
